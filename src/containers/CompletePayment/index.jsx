...
const STATUS_CONTENT_MAP = {
    succeeded: {
        text: "Pagamento efetuado com sucesso! Obrigado por comprar conosco.",
        iconColor: "#30B130",
        icon: SuccessIcon,
    ...
    return (
        <div className='container'>
            <div id="payment-status">
                ...
                <h2 id="status-text" className="StatusText">
                ...
                {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" rel="noopener noreferrer" target="_blank">Ver Detalhes
